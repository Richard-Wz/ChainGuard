...
async function deleteAppealRecord(adminID, appealID) {
  try {
    let ccpPath;
    // Choose connection profile based on adminID
    ...
    await contract.submitTransaction('DeleteAppeal', appealID);
...
module.exports = { deleteAppealRecord };
